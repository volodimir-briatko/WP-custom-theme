...
<div class="crumbs">
	<div class="container">
		<ul class="crumbs__list">
			...
			<li><a href="<?php echo get_permalink(101);?>"><?php echo get_the_title(101); ?></a></li>
...
<section class="has-bg blog_item">
	<div class="container">
		...
		<div class="text_page text_page1">
			...
			?>
			<?php $service_list_title = get_field('service_list_title'); if (!empty($service_list_title)): ?>
			<h5>What the process looks like</h5>
			<?php endif; ?>
			<?php $service_list = get_field('service_list'); if (!empty($service_list)): ?>
			<div class="services__ol">
				<div class="services__ol-content">
					<?php echo $service_list;?>
				</div>
				<img src="<?php bloginfo('template_url'); ?>/assets/img/services-page/CUBE.png" alt="" class="services__ol__img">
				<?php endif; ?>
			</div>
		</div>
		<script>
